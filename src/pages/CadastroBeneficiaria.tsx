...
export default function CadastroBeneficiaria() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Clean phone and CPF formats for database
      const cleanData = {
        ...formData,
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="indicacao_profissional">Indicação de Profissional</SelectItem>
                    <SelectItem value="rede_social">Redes Sociais</SelectItem>
                    <SelectItem value="conhecidos">Conhecidos/Familiares</SelectItem>
                    <SelectItem value="busca_propria">Busca Própria</SelectItem>
